...
- Em "list", use os filtros "nome_cliente, orçamento_numero, telefone_cliente".
...
- No campo "materiais", inclua "unidade" (ex: "m", "cm", "rolo", "kit", "caixa", "pacote", "dente").
...
`;
    ...
    // 3️⃣ Checa memória pendente (telefone faltando)
